...
var rootCmd = &cobra.Command{
	Use:   "ble-sniffer",
	Short: "Adafruit BLE Sniffer",
	Long:  `A command-line utility to control Adafrust BLE Sniffer.`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".ble-sniffer" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".ble-sniffer")
	}
